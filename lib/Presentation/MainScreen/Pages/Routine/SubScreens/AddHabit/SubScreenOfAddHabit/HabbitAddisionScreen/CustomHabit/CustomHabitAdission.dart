...
class _CustomHabitAdissionState extends State<CustomHabitAdission> {
  ...
  String habitIcon = 'assets/ImagesY/RoutineScreen/AddhabbitIcons/StayingFitIcons/Cardio_Icon.svg';
  Set<String> Subtasks={};
  // Target of the habit
  List<Color> colors = [
            ...
            Padding(
              ...
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemCount: properties.length, // Assuming you have 5 containers
                              ...
                              showModalBottomSheet(
                                  ...
                                  builder: (BuildContext context) {
                                    return TagBottomSheet(
                                      ...
                                      habitAddisionContext: context3, creatingNew: true,
                                    );
                                  });
                            }
                          }
