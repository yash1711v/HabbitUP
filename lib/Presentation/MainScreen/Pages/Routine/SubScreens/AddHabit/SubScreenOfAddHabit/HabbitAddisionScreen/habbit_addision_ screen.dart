    ...
    return BlocBuilder<HabitAdisionBloc, HabitAdisionState>(
      builder: (context, state) {
        ...
        List<bool> isSelected = List.generate(
            12,
            (index) =>
                index == SelectedColorIndex? true : false); // List to track selected state
          ...
          body: Column(
            children: [
              Padding(
                ...
                child: Center(
                    child:SvgPicture.asset(SelectedHabitIcon,color: colors[SelectedIndex],)),
              ),
               Text(
                selectedHabit,
                style: TextStyle(
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ListView.builder(
                    itemCount: Methods().Habbits[SelectedCatagory]![selectedHabit]!['properties'].length, // Assuming you have 5 containers
                    itemBuilder: (context, index) {
                      // Determine the decoration based on the index
                      List<String>Properties=Methods().Habbits[SelectedCatagory]![selectedHabit]!['properties'];
                      ...
                      } else if (index == Methods().Habbits[SelectedCatagory]![selectedHabit]!['properties'].length-1) {
                        decoration =  BoxDecoration(
                          color: Theme.of(context)
                              .inputDecorationTheme
                              .fillColor,
                             ...
                             child: Container(
                               ...
                               child: Row(
                                 ...
                                 children: [
                                   ...
                                   if(Properties.length==5)
                                      index==1?Padding(padding: const EdgeInsets.only(left: 3.0), child: Center(child: Text("30",style: TextStyle( fontFamily: 'DM Sans', fontWeight: FontWeight.w500,),)),):SvgPicture.asset(SubIcons[index==0?index:index-1],color: Theme.of(context).textTheme.headline1?.color,),
                                if(Properties.length==4)
                                  SvgPicture.asset(SubIcons[index],color: Theme.of(context).textTheme.headline1?.color,),
                                 ],
                               ),
                             ),
                           )
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(),
                          child:
                          SvgPicture.asset("assets/ImagesY/RoutineScreen/AddhabbitIcons/ComunityIcon.svg")),
